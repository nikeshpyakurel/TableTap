...
import { CategoryDrawer } from "../QuickFoodOrder/CategoryDrawer";
import { Sidebar } from "../QuickFoodOrder/Sidebar";
import { ActionButtons } from "../QuickFoodOrder/ActionButtons";
import { ProductCard } from "../QuickFoodOrder/ProductCard";
...
export default function QuickFoodOrder() {
  ...
  const [drawer, { open: openDrawer, close: closeDrawer }] =
    useDisclosure(false);
  const { cart, addToCart, clearCart } = useTableOrderCart();
